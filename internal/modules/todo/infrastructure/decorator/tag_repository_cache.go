...
func (r *tagRepositoryCache) Save(ctx context.Context, tag *domain.Tag) error {
	...
	db.AfterCommit(ctx, func(ctx context.Context) {
		_ = r.store.Delete(ctx, cache.Keys.Tag(tag.ID()))
		_ = r.store.Invalidate(ctx, cache.Keys.WorkspaceTag(tag.WorkspaceID()))
	})
...
func (r *tagRepositoryCache) FindByID(ctx context.Context, id domain.TagID) (*domain.Tag, error) {
	...
	return cache.GetOrFetch(ctx, r.store, key, r.ttl, r.codec, func(ctx context.Context) (*domain.Tag, error) {
...
func (r *tagRepositoryCache) Delete(ctx context.Context, id domain.TagID) error {
	...
	db.AfterCommit(ctx, func(ctx context.Context) {
		_ = r.store.Delete(ctx, cache.Keys.Tag(id))
		_ = r.store.Invalidate(ctx, cache.Keys.WorkspaceTag(tag.WorkspaceID()))
	})
