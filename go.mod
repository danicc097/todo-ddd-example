module github.com/danicc097/todo-ddd-example
...
require (
	...
	github.com/xataio/pg_query_go/v6 v6.0.0-20250425105130-ed1845ee2d75 // indirect
	github.com/xataio/pgroll v0.16.0 // indirect
